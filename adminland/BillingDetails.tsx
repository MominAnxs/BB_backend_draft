...
const statusStyle = (s: PaymentStatus) => {
  switch (s) {
    ...
    case 'Pending': return 'bg-rose-50 text-rose-600';
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between">
        ...
        <button className="flex items-center gap-2 px-4 py-2.5 bg-[#204CC7] text-white rounded-md text-body font-medium hover:bg-[#1a3da0] transition-all">
                                  ...
                                  return (
                                    <div key={acc.id} className="flex items-center gap-4 px-4 py-3 bg-white border border-black/[0.06] rounded-xl">
                                      ...
                                      <div className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[11px] font-semibold ${sc.bg}`}>
                                        ...
                                        {acc.serviceType === 'Performance Marketing' ? 'SEM' : 'A&T'}
                                      </div>
